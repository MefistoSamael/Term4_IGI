    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('theme', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='museum.theme')),
            ],
        ),
        migrations.CreateModel(
            name='Exhibition',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('exhibition', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='museum.exhibition')),
                ('exposition', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='museum.exposition')),
                ('hall', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='museum.hall')),
                ('observer', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='museum.employee')),
            ],
        ),
        migrations.CreateModel(
            name='Excursion',
        ...
        migrations.AddField(
            model_name='employee',
            name='position',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='museum.position'),
        ),
    ]
