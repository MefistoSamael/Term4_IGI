...
"""    def test_case_1(self):
        self.test_input = "Abc. Abc?!! Abc... abc. ABC! Abc..."
        ...
        self.sentences_amount(expected_amount_of_sentence, self.test_input, "TEST1")
        self.non_declarative_sentence_amount(expected_amount_of_non_declarative_sentence, self.test_input, 'TEST2')

        # Sentence amount test
        self.assertEqual(expected_amount_of_sentence, get_sentences_amount(self.test_input),
                         f'incorrect sentences amount {TEST}')
        # Non declarative sentences amount test
        self.assertEqual(expected_amount_of_non_declarative_sentence,
                         get_not_declarative_sentences_amount(self.test_input),
                         f'incorrect non declarative sentences amount {TEST}')
        # Average length of the sentence test
        self.assertEqual(expected_average_length_of_sentence, get_average_sentence_length(self.test_input),
                         f'incorrect average length of sentence {TEST}')
        # Average length of the word test
        self.assertEqual(expected_average_length_of_word, get_average_word_length(self.test_input),
                         f'incorrect average length of the word {TEST}')
        # Average length of the engrams
        self.assertEqual(expected_K_NGrams, n_grams(self.test_input, N, K),
                         f'incorrect count of engrams {TEST}')"""

"""    def test_case_2(self):
        self.test_input = ""

        TEST = "TEST2"
        expected_amount_of_sentence = 5
        expected_amount_of_non_declarative_sentence = 10
        expected_average_length_of_sentence = 7
        expected_average_length_of_word = 0
        expected_K_NGrams = []
        K = 10
        N = 2
